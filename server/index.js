...
app.get('/api/reviews', (req, res) => fetch(req, res, 'http://localhost:3004/api/reviews'));
app.delete('/api/reviews', (req, res) => {
  axios
    .delete('http://localhost:3004/api/reviews')
    .then(() => res.send())
    .catch(err => console.log(err))
});
app.get('/api/reviews/all', (req, res) => fetch(req, res, 'http://localhost:3004/api/reviews/all'));
